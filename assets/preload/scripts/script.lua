...
local yy = 600; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 400; -- Same code as above, but for boyfriend left, right
local yy2 = 620; -- Same code as above, but for boyfriend up, down
...
local ofs = 15;
local ofs2 = 50;-- Code to adjust the intensity with which the camera moves, the more numbers, the more intense, and the fewer numbers, less intense
